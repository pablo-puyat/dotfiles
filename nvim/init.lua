...
vim.keymap.set('n', '<leader>`', '<cmd>close<CR>', { desc = "Close currrent window" })
vim.keymap.set('n', 's', '<cmd>w<CR>', { desc = 'Save file' })
vim.keymap.set('n', 'S', '<cmd>w<CR>', { desc = 'Save file' })
vim.keymap.set('n', 'O', 'O<Esc>', { desc = 'Add blank line above' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      require('lspconfig').phpactor.setup {
        ...
        -- handlers = {
        --  ['textDocument/definition'] = require('phpactor.handlers').definition,
        -- },
      }
